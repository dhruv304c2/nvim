  ...
  -- },
	...
	{ -- LSP Configuration & Plugins
      ...
      local servers = {
          ...
          settings = {
            Lua = {
              ...
              workspace = {
                ...
                -- Alternative: uncomment this line if `lua_ls` is slow
                -- library = { vim.env.VIMRUNTIME },
              },
              completion = { callSnippet = "Replace" },
              -- Uncomment to disable `missing-fields` warnings
        ...
        jdtls = {
          cmd = { "jdtls" }, -- Assuming jdtls is in your PATH
...
-- LSP Capabilities and On Attach
local capabilities = vim.lsp.protocol.make_client_capabilities()
...
require("mason-lspconfig").setup_handlers({
  function(server_name)
    require("lspconfig")[server_name].setup {
      ...
      root_dir = servers[server_name] and servers[server_name].root_dir or nil,
